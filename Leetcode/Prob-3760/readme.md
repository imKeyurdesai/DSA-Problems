...
Return an integer denoting the **maximum** number of _substrings_ you can split `s` into such that each **substring** starts with a **distinct** character (i.e., no two substrings start with the same character).
